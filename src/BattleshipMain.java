...
public class BattleshipMain {
  ...
  public static void usage(String progName) {
    System.err.println(progName + ":[-v] [-l <game log file>] <game " +
            "configuration file> <ship location file 1> " +
            "<ship location file 2> <player 1 type> <player 2 type>");
    ...
    if (args.length == offset + 5) {
      ...
      if (p1 == null || p2 == null) {
        ...
        try {
          ...
          if (!world1.setupWorld(args[offset], args[offset + 1],
                  1, isVisual) ||
                  !world2.setupWorld(args[offset], args[offset + 2],
                          2, isVisual)) {
